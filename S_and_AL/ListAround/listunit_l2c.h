...
typedef struct tnodeL2C 
 ...
 // возвращает первый (first!=0) или последний (first==0) элемент в списке, больший data
 pnodeL2C AboveNodeL2C(pnodeL2C ph, int first, double data);
 // возвращает первый (first!=0) или последний (first==0) элемент в списке, меньший data
